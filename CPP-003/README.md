...
| 2.1  | `CPP-001`   | - *Fixity metadata*                              | Gather the *AIP*'s<br>                            fixity metadata                     | - *Fixity metadata*                                                                                     |             |
| 2.2  |             | - *Fixity metadata* (algorithms)                 | Calculate the checksum of the *AIP* from the specified *File*<br>                            path | - *Fixity metadata*                                                                                     |             |
| 2.3  |             | - *Fixity metadata*                              | Compare the calculated checksum with the stored checksum                              | - Checksums match: proceed to next step<br>- Alert that any of the checksums does not match: mark broken *AIP* for repair and proceed to next step | `CPP-004`   |
