...
| 14.a.1 |             | - *Information package* with fixity checked, identifier assigned, quality assessed, *Metadata* recorded and optionally new *Representation*s added | If *SIP* conforms to the requirements (steps 7a and 7b): *SIP* transformation to *AIP*                                                                                                                                                     | - *AIP*                                                              |             |
| 14.a.2 |             | - *AIP*                                                                                                                                            | Move the *AIP* to the archival storage                                                                                                                                                                                                     | - *AIP* on multiple locations                                        | `CPP-011`   |
