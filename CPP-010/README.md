...
| 3b   |             | - Results of manual tests                                                                                                                        | Assess and choose one among the following outputs (in the given order)                         | - Retain the File as it is<br>- Find another valid Representation (e.g. by establishing contact<br>                                with<br>                                the<br>                                producer)<br>- Trigger File Repair to correct the file structure<br>- Reject the *Object* | `CPP-027`   |
