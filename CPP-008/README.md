...
| :---------- | :---------- | :---------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------ | :---------- |
| 1           | `CPP-018`   | - *File*<br>- File format policy - Identification<br>- Tool: [format<br>                            identification tool](https://coptr.digipres.org/index.php/File_Format_Identification) | Apply the format identification tool(s) on the *File*                      | - File format identification information                                                    |             |
...
| 2a          |             | - File format identification information<br>- File format policy - Identification                                 | Analyse the format identification information and decide on next steps     | - A gap in the format registry is identified (step 2a- optional)<br>- Need for configuration update identified (step 2a- optional)<br>- Manual file format identification possible (step 3)<br>- Mark the *File* for later review and add the reason for review<br>                            to the event information (step 5)<br>- Reject the *File* (step 5) |             |
| 2a-optional |             | - *File*                                                                                                          | Contribute to format registries by providing sample File to the registry<br>                        administrators | - *File* samples<br>- Registry update request and/or signature submission                   |             |
| 2a-optional |             | - Format Identification Tool                                                                                      | Update system configuration                                                | - New configuration settings                                                                |             |
| 3           |             | - File format information<br>- File format policy - Identification                                                | Check if the file format is a container format and the policy requires its<br>                        content to be extracted | - Extraction required (e.g. as part of the ingest processing):<br>                            extract *File*, ingest it and start identification process anew<br>                            (step 1). This loop can be repeated as many times as needed.<br>- No extraction required (step 4) |             |
...
| 5           |             |                                                                                                                   | Register a format identification event containing the tool(s) name<br>                        and version and the(ir) outcome(s) | - *Provenance metadata*                                                                     |             |
