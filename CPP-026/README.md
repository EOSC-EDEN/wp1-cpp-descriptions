...
| :--- | :---------- | :------------------------------------------------- | :-------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------- | :---------- |
| 1.a  | `CPP-029`   | - Each *File* in the *Information Package*         | Perform the Format Identification process on the *File*(s)                                                |                                                                                                           |             |
| 1.b  | `CPP-018`   | - Change in file format policy - Preferred formats | Find *Files* that require change of normalisation by format, then<br>                            process each one |                                                                                                           |             |
...
| 5.a  |             | - OK                                               | Replace the original *File* with the normalised *File* (or add it) in the<br>                            *SIP* or *AIP* and adapt the *Fixity metadata* and *Technical metadata* | - updated *SIP* or *AIP*                                                                                  |             |
| 5.b  |             | - Error                                            | Report the error for the system or operator to decide further action                                      | - Stop the process                                                                                        |             |
