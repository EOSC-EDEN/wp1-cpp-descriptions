...
| 5b   |             | - Validated discovery *Metadata* with cleared rights  | If the TDA requires a PID (e.g. DOI), because the *Object* or *Metadata* about the *Object* will be publicly accessible (e.g. open<br>              access), the TDA may request a PID from an appropriate registration agency. The TDA<br>              may also add the PID to the *Metadata* in the catalogue service. | - PID                                                                                  |             |
| 5c   | `CPP-025`   | - *DIP* or Derivatives                                | The TDA may provide versions of its *Objects* for inclusion in<br>              the catalogue service (for example, thumbnails, preview versions, redacted documents<br>              etc.). These are added to the catalogue entry for the *Object*. | - Entry in catalogue service                                                           |             |
