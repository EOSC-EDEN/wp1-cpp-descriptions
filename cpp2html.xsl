...
<xsl:stylesheet 
    ...
    <xsl:param name="group-sequence-hue">210</xsl:param>
    <xsl:param name="group-alternative-hue">150</xsl:param>
    <xsl:param name="group-parallel-hue">330</xsl:param>
    <xsl:param name="base-lightness">95</xsl:param>
