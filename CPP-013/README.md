...
| :--- | :---------- | :-------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------- | :---------- |
| 1a   | `CPP-029`   | - Reporting request (from CPPs, stakeholders or the consumers) in the<br>                                form of a Report Specification | The TDA receives the request and determines what data is required to<br>                            provide the requested report | - Specification of the data required for the report                                |             |
...
| 2a   |             | - Specification of data required for the report (from 1a or 1c)       | If needed, CPPs that produce the required data are revised so that the<br>                            necessary<br>                            data is produced and compiles the report (as provided by other CPPs)<br>                        The TDA gathers and aggregates the data needed for the report. | - Data required for report                                                         |             |
