...
The T1.2 core task group is currently working on a machine-actionable CPP expression, intially produced as word-processing documents and published as PDFs. The work is currently developped in the [`dev` branch](https://github.com/EOSC-EDEN/wp1-cpp-descriptions/tree/dev).
