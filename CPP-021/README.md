...
| 3.a  |             | - Additional incoming Metadata<br>- AIP Metadata                            | If the intended update concerns only Metadata, update<br>                                the AIP Metadata | - Digital archive database update        |             |
| 3.b  |             | - SIP (if relevant)<br>- AIP<br>- File(s) or Representation(s) that should replace<br>                                    existing File(s) or be added to the AIP<br>- Versioning policy | If the update involves the addition of Files, request<br>                                corresponding physical AIP and perform merging with<br>                                incoming data and Metadata | - Content of the new AIP version<br>- Digital archive database update |             |
| 3.c  |             | - Versioning policy                                                         | If the update is a “full update”, ingest data and<br>                                Metadata as a complete replacement of the previous AIP<br>                                version | - Digital archive database update        |             |
