...
| 5    |             | - Tool output (raw or in a standard format)                                                                                                     | Recording the results in the Information Package (i.e. in practice, in the<br>                        digital archive database and/or in the physical Information Package) | - Technical metadata, optionally other types of metadata, recorded in<br>                            the<br>                            Information Package | `CPP-029`   |
