...
| :--- | :---------- | :-------------------------------------------------- | :------------------------------------------------------------------------------------------------ | :--------------------------------- | :---------- |
| 1.a  | `CPP-025`   | - Request for access copy and requested *Object(s)* | Identify the *Representation* to be processed                                                     | - *Representation*                 |             |
| 1.b  | `CPP-029`   | - Ingest of a *SIP*                                 | Iterate over the *Representations* in the *SIP*                                                   | - *Representation*                 |             |
...
| 5.a  |             | - *DIP*                                             | Deliver the *DIP* and end the process                                                             |                                    |             |
| 5.b  | `CPP-001`   | - *Representation* or *AIP*                         | Apply the characterisation processes against the new *Object*,<br>                                optionally by running the ingest process and all its subprocesses | - Validated *Object*               | `CPP-015`   |
