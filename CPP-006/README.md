...
| :----------- | :---------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------- |
| **Sequence** |             |                                                                                                                                                             |                                                                                                                                                                                                                                                                          |                                                                                                                                                                            |             |
|   1          |             |                                                                                                                                                             | aReceive list of *AIPs* to be exported (sequence)                                                                                                                                                                                                                        |                                                                                                                                                                            |             |
|   2          |             | - Target structure and format of exported *AIP*                                                                                                             | Optional (if multiple target structures and formats are supported): Set export to transform 				exported *AIP* to desired structure and format (sequence)                                                                                                                |                                                                                                                                                                            |             |
...
|   4          |             | - Inventory of *AIPs* - Inventory of *AIPs* versions                                                                                                        | Optional (depending on handling method for updates in TDA) for each *AIP*:             Lock AIP to avoid it being updated during export (sequence)                                                                                                                       | - Locked location of source *AIP*                                                                                                                                          |             |
|   5          |             | - Inventory of AIPs - Inventory of AIPs versions - *Storage Metadata Information*                                                                           | For each *AIP* in inventory list: Create logical structure for *AIP* (sequence)                                                                                                                                                                                          |                                                                                                                                                                            |             |
|   6          |             |                                                                                                                                                             | For each *AIP* in inventory list: Write logical structure to target location (sequence)                                                                                                                                                                                  | - Logical structure tree of exported *AIPs*                                                                                                                                |             |
|   7          |             |                                                                                                                                                             | For each *AIP* in inventory list: Copy *Files* to target location (sequence)                                                                                                                                                                                             | - Files in logical structure tree of exported *AIPs*                                                                                                                       |             |
|   8          |             | - Database query for *AIP*                                                                                                                                  | For each *AIP* in inventory list:             If (additional) *Metadata* is stored in other place tha *AIP* (e.g., database): 					collect all other information belonging to *AIP* (*Metadata*) (sequence)                                                              | - All information belonging to *AIP*                                                                                                                                       |             |
|   9          |             | - Result of Database query for *AIP* - Maping for export of selected *Metadata* from database to flat *Metadata*                                            | For each *AIP* in inventory list:             If (additional) *Metadata* is stored in database, transform *Metadata* into target 				format and write to target location, add export as provenance information into Metadata 				*File* during transformation (sequence) | - Metadata *File(s)* in target location - Provenance information in metadata *File(s)*                                                                                     |             |
|   10         |             | - Inventory of *AIPs* - Inventory of *AIP* versions - List of *Files* (excluding *Metadata* files) at target location - *Fixity Metadata* from source *AIP* | For each *AIP* in inventory list: The *AIP* in the target should be verified, 				including *Files* and *Metadata* to ensure it is complete and correct ´				(e.g. using checksums) (sequence)                                                                           | - Number of *Files* matches (step 12) - All checksums match (step 12) - Alert that number of *Files* do not match - Alert that any of the *File*  checksums does not match |             |
|   11         |             | - *AIP* ID                                                                                                                                                  | Optional (depending on handling method for updates in TDA):             for each *AIP*: Release lock on *AIP* (sequence)                                                                                                                                                 | - Released lock                                                                                                                                                            |             |
|   12         |             | - *Files* in target location - Target structure and format of exported *AIP*                                                                                | If required: perform additional repacking of *Files* at target location to meet 				target structure and format of exported *AIP* (e.g., tarball) (sequence)                                                                                                             |                                                                                                                                                                            |             |
|   13         |             | - List of *AIPs*                                                                                                                                            | Repeat steps 5-12 for each *AIP* to be exported (sequence)                                                                                                                                                                                                               |                                                                                                                                                                            |             |
|   14         |             | - Documentation of Export *AIP* (supported target structure and format of exported *AIP*)                                                                   | Add documentation to target location (sequence)                                                                                                                                                                                                                          | - Documentation of Export *AIP* (supported target structure and format of exported *AIP*                                                                                   |             |
|   15         |             | - Inventory of *AIPs*                                                                                                                                       | Document export in audit trail (sequence)                                                                                                                                                                                                                                | - Audit trail for export                                                                                                                                                   |             |
