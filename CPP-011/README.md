...
| :--- | :---------- | :---------------------------------- | :---------------------------------------------------------- | :----------------------------------------- | :---------- |
| 1    | `CPP-012`   | - Copy management policy<br>- Storage management information<br>- AIP | Identify and locate *AIP* to be replicated                  | - Inventory of *AIP* to be replicated<br>- Source storage medium with *AIP* |             |
