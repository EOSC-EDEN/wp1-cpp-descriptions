...
| :--- | :---------- | :-------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------- | :------------------------------------------------ | :---------- |
| 1a   |             | - A producer or a TDA has a need to reserve an identifier, <br>                                    (e.g. a PID, prior to the entity being added) | Reservation of identifier prior to new entity assignment (step 2)                 |                                                   |             |
