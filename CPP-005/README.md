...
| 3    | - *(new) Identifier*<br>- *Object*<br>- *Information package*<br>- *Metadata*                            | Assign the new identifier to the entity and add it as a part of the entity’s Metadata                                   | - Metadata                                        |
...
| 7    | - *Disposed entity*                                                                                      | If the entity is disposed: retain minimum metadata and the identifier for the disposed entity                           |                                                   |
