...
| 5.a  |             | - Authenticated and authorised request      | The TDA locates the *AIP* or set of *AIPs*, from which the *DIP*<br>                is created                      | - *AIP* or a set of *AIPs*                                                        |             |
| 5.b  |             | - Non-authenticated or unauthorised request | The TDA responds with error                                                                                         | - Error response                                                                  |             |
